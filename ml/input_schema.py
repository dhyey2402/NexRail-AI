...
from dynamic_features import synthesize_dynamic_features
...
def validate_prediction_input(features: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Build sanitized output with dynamic operational, weather, and seasonal synthesis
    ...
    # Apply deterministic dynamic feature synthesis (replaces static DOMAIN_DEFAULTS)
    sanitized = synthesize_dynamic_features(sanitized)
