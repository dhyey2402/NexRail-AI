 ...
 * This is convenient for the initial MVP and simplifies Capacitor mobile packaging.
 ...
 * Secure, HttpOnly cookies for web, and Secure Storage for Capacitor.
 */

const TOKEN_KEY = 'railwise_auth_token'
